<template>
  <div class='sub-sort'>
    ...
    <div class="check">
      <JxCheckbox @change="changeCheck" v-model="sortParams.inventory">仅显示有货商品</JxCheckbox>
      <JxCheckbox @change="changeCheck" v-model="sortParams.onlyDiscount">仅显示特惠商品</JxCheckbox>
    </div>
  </div>
</template>
<script>
