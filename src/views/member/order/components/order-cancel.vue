<template>
  <JxDialog title="取消订单" v-model:visible="visibleDialog">
    <!-- 取消原因列表 -->
    ...
    <!-- 按钮操作 -->
    <template #footer>
      <JxButton type="gray" @click="visibleDialog=false" style="margin-right:20px">取消</JxButton>
      <JxButton type="primary" @click="submit">确认</JxButton>
    </template>
  </JxDialog>
</template>
<script>
