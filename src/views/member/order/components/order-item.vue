  ...
  <div class="order-item">
    ...
    <div class="body">
      ...
      <div class="column action">
        ...
        <!-- 已完成：查看详情，再次购买，申请售后 -->
        <!-- 已取消：查看详情 -->
        <JxButton @click="$router.push(`/member/pay?orderId=${order.id}`)" v-if="order.orderState===1" type="primary" size="small">立即付款</JxButton>
        <JxButton @click="$emit('on-confirm', order)" v-if="order.orderState===3" type="primary" size="small">确认收货</JxButton>
