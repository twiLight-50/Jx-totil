<template>
  <div class="checkout-address">
    ...
    <div class="action">
      <JxButton @click="openDialog()" class="btn">切换地址</JxButton>
      <JxButton @click="openAddressEdit({})" class="btn">添加地址</JxButton>
    </div>
  </div>
  <!-- 对话框组件-切换收货地址 -->
  <JxDialog title="切换收货地址" v-model:visible="visibleDialog">
    ...
    <template #footer>
      <JxButton @click="visibleDialog=false" type="gray" style="margin-right:20px">取消</JxButton>
      <JxButton @click="confirmAddressFn" type="primary">确认</JxButton>
    </template>
  </JxDialog>
  <!-- 收货地址添加编辑组件 -->
