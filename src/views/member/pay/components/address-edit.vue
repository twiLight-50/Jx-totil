<template>
  <JxDialog :title="`${formData.id?'修改':'添加'}收货地址`" v-model:visible="visibleDialog">
    <!-- 表单 -->
    <div class="address-edit">
      <div class="Jx-form">
        ...
        <div class="Jx-form-item">
          ...
          <div class="field">
            <JxCity :fullLocation="formData.fullLocation" @change="changeCity" placeholder="请选择所在地区"/>
          </div>
        </div>
        <div class="Jx-form-item">
    ...
    <template #footer>
      ...
      <JxButton @click="submit()" type="primary">确认</JxButton>
    </template>
  </JxDialog>
</template>
<script>
