  ...
  <div class="Jx-pay-page">
    <div class="container">
      <JxBread>
        ...
        <JxBreadItem to="/cart">购物车</JxBreadItem>
        <JxBreadItem>支付结果</JxBreadItem>
      </JxBread>
      <!-- 支付结果 -->
      <div class="pay-result">
        ...
        <div class="btn">
          <JxButton @click="$router.push('/member/order')" type="primary" style="margin-right:20px">查看订单</JxButton>
          <JxButton type="gray">进入首页</JxButton>
        </div>
        <p class="alert">
